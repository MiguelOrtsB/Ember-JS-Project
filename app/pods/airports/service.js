...
export default class AirportsService extends Service {
    ...
    loadAirports() {
        ...
        this.airportsList = JSON.parse(sessionStorage.getItem('airports'));
        } else {
        let me =
            this; /* Con cualquier llamada asíncrona perdemos el scope (this), por eso iniciamos esta variable para que apunte a todo el archivo service y poder acceder a sus 
        ...
        let headers = {
            ...
            'x-session-id': me.Application.token.sessionid,
        };
        ...
        $.ajax({
            ...
            sessionStorage.setItem('airports', JSON.stringify(me.airportsList));
