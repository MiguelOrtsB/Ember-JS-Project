    ...
    const documentDefinition = {
      ...
      content: [
        ...
        },
        {
          text: [
            'Fecha de expedición: ',
            { text: actualDate, bold: true },
            '\n',
            'ID de Booking: ',
            { text: booking.id, bold: true },
            '\n',
            'ID de Hotel: ',
            { text: booking.hotelId, bold: true },
            '\n',
            'Check-in : ',
            { text: booking.startDate, bold: true },
            '\n',
            'Check-out : ',
            { text: booking.endDate, bold: true },
          ],
          style: 'header',
        },
        {
      ...
      footer: {
        columns: [
          {
            text: 'Carrer del Fluvià, 1, 1 + 3º izda, Llevant, 07009 Palma, Illes Balears',
            alignment: 'center',
            fontSize: 10,
          },
          {
            text: 'Teléfono: +34 871170555',
            alignment: 'center',
            fontSize: 10,
          },
        ],
